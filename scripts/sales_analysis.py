...
def plot_acf_pacf(df):
    ...
    # Resample the sales data to monthly data for clearer trends
    monthly_sales = df['Sales'].resample('M').sum()
    ...
    ax1.stem(range(len(acf_values)), acf_values)  # Removed use_line_collection
    ...
    ax2.stem(range(len(pacf_values)), pacf_values)  # Removed use_line_collection
